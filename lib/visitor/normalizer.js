...
var Normalizer = module.exports = function Normalizer(root, options) {
  ...
  this.extends = {};
  this.map = {};
  this._sourcemaps = options._sourcemaps;
};
  ...
  group.extends.forEach(function(extend){
    ...
    selectors.forEach(function(selector){
      ...
      groups.forEach(function(group){
        if (self._sourcemaps && self._sourcemaps.extends) {
          self._sourcemaps.extends.push([extend.lineno, extend.selector,
            extend.filename, group.lineno, group.filename]);
        }
